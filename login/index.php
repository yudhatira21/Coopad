            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="mt-3 d-grid">
                                        <button class="btn btn-primary waves-effect waves-light" type="button"
                                            id="login" name="login">Log In</button>
                                    </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p>Tidak punya akun ? <a href="/new/register" class="fw-medium text-primary"> Daftar
                                    sekarang </a> </p>
                            <p>© <script>
                                    document.write(new Date().getFullYear())
                                </script> Coopad. Crafted with <i class="mdi mdi-heart text-danger"></i> by kelompok 10
                            </p>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#login").click(function () {
                /*#login mengambil id button login*/

                let formData = new FormData();
                formData.append('email', $('#email')
                    .val()); /*form data membuat formdata email dan password*/
                ...
                $.ajax({
                    ...
                    /*tujuan yang akan di tuju*/
                    data: formData,
                    dataType: 'json',
                    /*data type yang akan ditampilkan adalah json*/
                    cache: false,
                    processData: false,
                    contentType: false,
                    ...
                    beforeSend: function (e) {
                        $('#login').html(
                            '<i class="fa fa-spinner fa-spin"></i> &nbsp; Mencoba login...'
                        );
                    },
                    ...
                    success: function (data) {
                        ...
                        if (data.status == 1) {
                            $('#modal_gagal').modal(
                                'show'
                            ); /*jika result kirim gagal maka menampilkan data msg tulisan*/
